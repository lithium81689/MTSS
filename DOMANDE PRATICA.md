...
Github actions è il **sistema di automazione** integrato di github che permette di **definire dei workflow** (in file **YAML** nella cartella **.github/workflows**) eseguiti automaticamente in **risposta** **a** **eventi** come push o pull\_request
...
Nel contesto della **CONTINUOUS INTEGRATION**, ogni **modifica integrata nel repository** viene verificata automaticamente tramite la **pipeline**, così da **individuare** rapidamente **errori di compilazione** o **test falliti** e mantenere la **main branch sempre stabile**
